...
Declaring a new global signal is a Core change (v0.6.0: eleven signals declared, see reference below): it must be added to
...
As of v0.6.0 the bus declares eleven signals in total; see the full reference below.

### Declared signals (11 total as of v0.6.0)
